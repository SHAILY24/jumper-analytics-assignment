# Content Engagement Analytics - Deployment Guide
...
```bash
cd /path/to/content-engagement-analytics
...
```nginx
# File: /etc/nginx/sites-enabled/engagement-analytics.yourdomain.com

# HTTP to HTTPS redirect
server {
    listen YOUR_SERVER_IP:80;
    server_name engagement-analytics.yourdomain.com;
...
cd /path/to/content-engagement-analytics/api
pm2 start "uv run uvicorn main:app --host 127.0.0.1 --port 13516" --name engagement-analytics-api
...
# View logs
pm2 logs engagement-analytics-api

# Monitor
pm2 monit

# Restart
pm2 restart engagement-analytics-api

# Stop
pm2 stop engagement-analytics-api
```
...
```bash
pm2 logs engagement-analytics-api
pm2 logs engagement-analytics-api --lines 100
```

**Nginx logs:**
```bash
sudo tail -f /var/log/nginx/access.log | grep engagement-analytics
...
- **URL:** http://127.0.0.1:13516
- **API Documentation:** http://127.0.0.1:13516/docs
...
- GitHub: https://github.com/SHAILY24/content-engagement-analytics
